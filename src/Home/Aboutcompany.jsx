...
const Aboutcompany = () => {
    ...
    return (
        <div className='container '>
            <div className=' py-3 mt-10 flex justify-center items-center flex-1  flex-col sm:flex-row '>
                        ...
                        {servicesList.map((item, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <div className="xl:text-xl lg:text-lg md:text-base text-sm font-semibold px-3 py-2 bg-white group-hover:text-white group-hover:bg-primary rounded-lg w-fit z-20 relative">{head}</div>
                                        <div className={` z-20 relative ${isHovered ? '-translate-y-7' : 'translate-y-16'} transition-transform duration-700`}>
